...
di default si usa il modello BM25, ma è possibile cambiarlo(in base al modello scelto, le query danno risultati differenti).

eseguire il main per fare partire l'applicazione...
l'applicazione presenta un menù testuale dove ci sono 6 opzioni tra cui scegliere.
(per scegliere bisogna inserire il numero relativo all'opzione che si voule eseguire e premere invio)
le opzioni permetto di creare un indice, indicizzare documenti dal file csv, scrivere query e cambiare modello di information retrival.
...
Inoltre c'è anche la possibilità di calcolare il DCG delle query di benchmark, in fondo al read me ci saranno comunque i DCG calcolati da noi.
